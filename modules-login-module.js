            ...
            this.subscribe = this.loginService.adminLogin(this.loginParams()).subscribe((data) => {
                if (data.status == true) {
                    ...
                    if (data.result.transferToken) {
                        localStorage.setItem(src_app_constant_app_constant__WEBPACK_IMPORTED_MODULE_5__["AppConstant"].USER_TRANSFER_TOKEN, JSON.stringify(data.result.transferToken));
                    }
                    this.userInfo = {
